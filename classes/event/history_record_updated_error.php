...
class history_record_updated_error extends history_record_updated
{
    public function get_description()
    {
        $description = "User with id '{$this->get_user_id()}'";
        $description .= " couldn't updated AI writer history record with id '{$this->objectid}'";
    ...
    {
        return factory::make()->moodle()->get_string('event_history_record_updated_error');
    }
}
